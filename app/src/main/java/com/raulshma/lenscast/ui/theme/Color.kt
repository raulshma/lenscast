...
val LensInk = Color(0xFF112031)
val LensInkSoft = Color(0xFF22354A)
val LensFog = Color(0xFF667A92)
val LensMist = Color(0xFFE5EDF6)
val LensCloud = Color(0xFFF6F8FC)
val LensBlue = Color(0xFF2196F3)
